//ported from baystation 12, thankies.
/mob/living/carbon/human/verb/give(var/mob/living/target in view(1)-usr)
	...
	if(I.loc != usr || (usr.get_active_held_item() != I && usr.get_inactive_held_item() != I))
	...
	if(target.get_active_held_item() != null && target.get_inactive_held_item() != null)
